...
%\usepackage{newtxtt}        % font package of txtt (in order to show minus sign in custom listings environment)
% Default fixed font does not support bold face
\usepackage{fontspec,xltxtra,xunicode}      % replace package "newtxtt"
\defaultfontfeatures{Mapping=tex-text}

\DeclareFixedFont{\ttb}{T1}{txtt}{bx}{n}{12} % for bold
\DeclareFixedFont{\ttm}{T1}{txtt}{m}{n}{12}  % for normal
\DeclareFixedFont{\ttbblock}{T1}{txtt}{bx}{n}{10} % for bold in code block
\DeclareFixedFont{\ttmblock}{T1}{txtt}{m}{n}{10}  % for normal in code block

% settings for 'command' environment
\newcommand\commandstyle{\lstset{
	%language=Bash,
	basicstyle=\ttm,
	tabsize=4,                        % tab width
	numberstyle=\ttm,
	...
	gobble=4,                         % trim leading spaces
	aboveskip = \baselineskip,        % to offset(neutralize) the custom \parskip (which is set to a \baselineskip)
	literate={-}{-}1 {*}{\normalfont{*}}1,                 % keep hyphen from combining into one
}}
...
\newcommand\pythonblockstyle{\lstset{
		language=Python,
		basicstyle=\ttmblock,
		commentstyle=\ttmblock\color{Gray},
		tabsize=4,                        % tab width
		numberstyle=\ttm,
		morekeywords={self},              % Add keywords here
		keywordstyle=\ttbblock\color{deepblue},
		emph={MyClass,__init__},          % Custom highlighting
		emphstyle=\ttbblock\color{deepred},    % Custom highlighting style
		...
		aboveskip = \baselineskip,        % to offset(neutralize) the custom \parskip (which is set to a \baselineskip)
		literate={-}{-}1 {±}{$\pm$}1 {*}{\normalfont{*}}1,     % keep hyphen from combining into one
		upquote=true,                     % make single quote "stragiht", need to work with 'textcomp' package
}}
...
\newcommand\pythonexternal[2][]{{
		...
		\lstinputlisting[
		#1,
		inputpath = ./code,      % default input path
		title={\parbox{\textwidth}{\hfill\ttm{#2}}}, % make title right-aligned with fixed-width typeface
		numbers=left, numbersep=2em,  % line number settings
		]{#2}}}
